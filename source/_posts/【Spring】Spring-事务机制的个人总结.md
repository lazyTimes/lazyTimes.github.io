...
![](https://adong-picture.oss-cn-shenzhen.aliyuncs.com/adong/20220902105321.png)
...
此外在spring5.0之后的版本又增加了新的获取方式，比如spring-test有`AopTestUtils`来获取，下面我们汇总一下这些方法，如果读者感兴趣可以实际验证一遍：
