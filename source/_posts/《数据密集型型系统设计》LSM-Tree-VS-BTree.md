 ...
 **读写方式**：`db_set xx`设置数据，`db_get xx`读取数据，修改一个key通过最后一行追加形式，意味着更新和删除操作没有任何的开销，无需关注并发的问题。
...
> 为什么数据页要固定大小？
> 这和磁盘的读写有关，传统机械硬盘为512b最小单位，而SSD通常为4KB最小单位读写，所以数据页设计为和磁盘兼容的形式存储有利于**顺序读写**，同时可以最大化利用磁盘空间。

![](https://gitee.com/lazyTimes/imageReposity/raw/master/img/202204022303218.png)
...
单纯对比数据结构可能比较枯燥，这里从老外的网站上找了一份**Mysql**和**LevelDB**的对比，这两款基本可以代言Btree和LSM-Tree这两种数据结构了。可以看到LevelDB要比Mysql的出现晚上不少，这和BigTable有着密切关系，也和网络时代的发展和互联网的用户量指数上升有关系。

| Name                                                         | LevelDB [X](https://db-engines.com/en/system/MySQL)          | MySQL [X](https://db-engines.com/en/system/LevelDB)          |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Description                                                  | Embeddable fast [key-value storage](https://db-engines.com/en/article/Key-value+Stores) library that provides an ordered mapping from string keys to string values | Widely used open source [RDBMS](https://db-engines.com/en/article/RDBMS) |
| Primary database model                                       | [Key-value store](https://db-engines.com/en/article/Key-value+Stores) | [Relational DBMS](https://db-engines.com/en/article/RDBMS) ![info](https://db-engines.com/info.png) |
| Secondary database models                                    |                                                              | [Document store](https://db-engines.com/en/article/Document+Stores) [Spatial DBMS](https://db-engines.com/en/article/Spatial+DBMS) |
| [DB-Engines Ranking](https://db-engines.com/en/ranking) ![info](https://db-engines.com/info.png)[![ranking trend](https://db-engines.com/ranking_trend_s.png)](https://db-engines.com/en/ranking_trend/system/LevelDB%3BMySQL)[Trend Chart](https://db-engines.com/en/ranking_trend/system/LevelDB%3BMySQL) | Score3.19Rank#97 [Overall](https://db-engines.com/en/ranking)#18 [Key-value stores](https://db-engines.com/en/ranking/key-value+store) | Score1204.16Rank#2 [Overall](https://db-engines.com/en/ranking)#2 [Relational DBMS](https://db-engines.com/en/ranking/relational+dbms) |
| Website                                                      | [github.com/­google/­leveldb](https://github.com/google/leveldb) | [www.mysql.com](https://www.mysql.com/)                      |
| Technical documentation                                      | [github.com/­google/­leveldb/­blob/­master/­doc/­index.md](https://github.com/google/leveldb/blob/master/doc/index.md) | [dev.mysql.com/­doc](https://dev.mysql.com/doc/)             |
| Developer                                                    | Google                                                       | Oracle ![info](https://db-engines.com/info.png)              |
| Initial release                                              | 2011                                                         | 1995                                                         |
| Current release                                              | 1.23, February 2021                                          | 8.0.28, January 2022                                         |
| License ![info](https://db-engines.com/info.png)             | Open Source ![info](https://db-engines.com/info.png)         | Open Source ![info](https://db-engines.com/info.png)         |
| Cloud-based only ![info](https://db-engines.com/info.png)    | no                                                           | no                                                           |
| DBaaS offerings (sponsored links) ![info](https://db-engines.com/info.png) |                                                              | [ScaleGrid for MySQL](https://t.sidekickopen79.com/s1t/c/5/f18dQhb0SdYj8bGch0W2n0x6l2B9nMJW7t69v68pTbB4W63Bc1d16gGCMf3DJp1901?te=W3R5hFj4cm2zwW4cHbrv3K4dNZW3GGZrk1LBf35F47PNcYS6TW1&si=370885007&pi=a68632e2-e84c-4cff-8541-4a0fd2702aba): Fully managed MySQL hosting on AWS, Azure and DigitalOcean with high availability and SSH access on the #1 multi-cloud DBaaS. |
